...
libs_softmmu=-lpixman-1 -lutil -lnuma -lpng16 -lz -lnettle -lgnutls -lxenctrl -lxenstore -lxenguest -lxenforeignmemory -lxengnttab -lxenevtchn -lxendevicemodel  -llzo2 -lsnappy -lrdmacm -libverbs -libumad -lfdt -lspice-server
GIT=git
...
LIBS_TOOLS+=-lutil -lcap-ng -lnettle -lgnutls 
PTHREAD_LIB=
EXESUF=
DSOSUF=.so
